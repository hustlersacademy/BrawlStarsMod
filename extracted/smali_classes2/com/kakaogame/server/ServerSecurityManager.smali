...
.method public static synthetic a(Ljava/net/URL;Ljava/lang/String;Ljavax/net/ssl/SSLSession;)Z
    .locals 0
...
.method public static final getHostnameVerifier(Ljava/net/URL;)Ljavax/net/ssl/HostnameVerifier;
    ...
    .line 5
    .line 6
    new-instance v3, Lcom/kakaogame/server/a;

    .line 7
    .line 8
    invoke-direct {v3, p0}, Lcom/kakaogame/server/a;-><init>(Ljava/net/URL;)V
...
.method private static final getHostnameVerifier$lambda-0(Ljava/net/URL;Ljava/lang/String;Ljavax/net/ssl/SSLSession;)Z
    ...
    .line 5
    .line 6
    sget-object v3, Lcom/kakaogame/server/ServerSecurityManager;->INSTANCE:Lcom/kakaogame/server/ServerSecurityManager;

    .line 7
    .line 8
    invoke-direct {v3, p0}, Lcom/kakaogame/server/ServerSecurityManager;->isRealHost(Ljava/net/URL;)Z
...
.method public static final getSSLSocketFactory()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 2
    .line 3
    invoke-direct {v3}, Lcom/kakaogame/server/ServerSecurityManager;->getTrustManager()Ljavax/net/ssl/TrustManager;
    ...
    invoke-static/range {v0 .. v0}, Lcom/kakaogame/server/ServerSecurityManager;->d(I)[C
    ...
    .line 19
    .line 20
    invoke-virtual {v4, v5, v6, v5}, Ljavax/net/ssl/SSLContext;->init([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V

    .line 21
    .line 22
    .line 23
    new-instance v3, Lcom/kakaogame/server/NoSSLv3SocketFactory;
    ...
    invoke-static/range {v0 .. v0}, Lcom/kakaogame/server/ServerSecurityManager;->b(I)[C
    ...
    .line 33
    .line 34
    invoke-direct {v3, v4}, Lcom/kakaogame/server/NoSSLv3SocketFactory;-><init>(Ljavax/net/ssl/SSLSocketFactory;)V
...
.method private final isRealHost(Ljava/net/URL;)Z
    ...
    .line 33
    invoke-static {p1, v5, v4, v6, v3}, Lkotlin/text/e0;->contains$default(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
    ...
    invoke-direct/range {v0 .. v1}, Lcom/kakaogame/server/ServerSecurityManager;->a(I)[C
    ...
    invoke-direct/range {v0 .. v1}, Lcom/kakaogame/server/ServerSecurityManager;->c(I)[C
