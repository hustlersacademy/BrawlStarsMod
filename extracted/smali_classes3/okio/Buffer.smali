...
.method private final digest(Ljava/lang/String;)Lokio/ByteString;
    ...
    .line 34
    invoke-virtual {p1, v5, v6, v7}, Ljava/security/MessageDigest;->update([BII)V
    ...
    .line 53
    .line 54
    invoke-direct {v3, p1}, Lokio/ByteString;-><init>([B)V
...
.method private final hmac(Ljava/lang/String;Lokio/ByteString;)Lokio/ByteString;
    ...
    .line 29
    invoke-virtual {v3, p2, v4, v5}, Ljavax/crypto/Mac;->update([BII)V
    ...
    .line 38
    .line 39
    iget-object v4, p2, Lokio/Segment;->data:[B

    .line 40
    .line 41
    iget v5, p2, Lokio/Segment;->pos:I

    .line 42
    .line 43
    iget v6, p2, Lokio/Segment;->limit:I
...
.method public final copyTo(Ljava/io/OutputStream;JJ)Lokio/Buffer;
    ...
    invoke-virtual {p1, v6, p2, p3}, Ljava/io/OutputStream;->write([BII)V
...
.method public final hmacSha1(Lokio/ByteString;)Lokio/ByteString;
    ...
    .line 7
    .line 8
    invoke-direct {p0, v3, p1}, Lokio/Buffer;->hmac(Ljava/lang/String;Lokio/ByteString;)Lokio/ByteString;
...
.method public indexOf(BJJ)J
    ...
    iget v8, p1, Lokio/Segment;->pos:I
    ...
    .line 14
    :goto_3
    iget v11, p1, Lokio/Segment;->pos:I
    ...
    .line 15
    :cond_6
    iget v12, p1, Lokio/Segment;->limit:I
    ...
    invoke-static/range {p3 .. p3}, Lokio/Buffer;->m(I)[C
    ...
    invoke-static/range {p3 .. p3}, Lokio/Buffer;->u(I)[C
    ...
    invoke-static/range {p3 .. p3}, Lokio/Buffer;->p(I)[C
...
.method public indexOf(Lokio/ByteString;)J
    ...
    .line 3
    invoke-virtual {p0, p1, v3, v4}, Lokio/Buffer;->indexOf(Lokio/ByteString;J)J
...
.method public indexOf(Lokio/ByteString;J)J
    ...
    const v19, 0x75769e66

    const v18, 0x434dfc8f

    sub-int v19, v19, v18

    add-int/lit8 v19, v19, 0x49

    move-object/16 v18, p0

    invoke-direct/range {v18 .. v19}, Lokio/Buffer;->v(I)[C
    ...
    invoke-direct/range {v18 .. v19}, Lokio/Buffer;->i(I)[C
    ...
    const v19, 0x32f30fed

    const v18, -0x39e179b

    rsub-int/lit8 v19, v19, -0x72

    xor-int v19, v19, v18

    move-object/16 v18, p0

    invoke-direct/range {v18 .. v19}, Lokio/Buffer;->q(I)[C
...
.method public indexOfElement(Lokio/ByteString;)J
    ...
    .line 1
    invoke-virtual {p0, p1, v3, v4}, Lokio/Buffer;->indexOfElement(Lokio/ByteString;J)J
...
.method public indexOfElement(Lokio/ByteString;J)J
    ...
    const p3, 0x58fa1a51    # 2.19992748E15f

    xor-int p1, p1, p3

    add-int/lit8 p1, p1, -0x3

    invoke-static/range {p1 .. p1}, Lokio/Buffer;->s(I)[C
    ...
    invoke-static/range {p1 .. p1}, Lokio/Buffer;->c(I)[C
...
.method public final md5()Lokio/ByteString;
    ...
    .line 2
    .line 3
    invoke-direct {p0, v3}, Lokio/Buffer;->digest(Ljava/lang/String;)Lokio/ByteString;
...
.method public readDecimalLong()J
    ...
    .line 88
    .line 89
    const v17, 0x1877ee27

    const v16, -0x72a468b8
    ...
    invoke-direct/range {v16 .. v17}, Lokio/Buffer;->b(I)[C
    ...
    .line 173
    .line 174
    const v17, 0x7773de02

    const v16, -0x4a97755f
    ...
    invoke-direct/range {v16 .. v17}, Lokio/Buffer;->k(I)[C
    ...
    const v16, 0x5dc6ee49

    add-int v17, v17, v16

    add-int/lit8 v17, v17, -0x38

    move-object/16 v16, p0

    invoke-direct/range {v16 .. v17}, Lokio/Buffer;->e(I)[C
    ...
    .line 180
    .line 181
    const v17, 0x557ce108

    const v16, 0x40f384be
    ...
    invoke-direct/range {v16 .. v17}, Lokio/Buffer;->h(I)[C
...
.method public final readFrom(Ljava/io/InputStream;)Lokio/Buffer;
    ...
    .line 1
    invoke-direct {p0, p1, v3, v4, v5}, Lokio/Buffer;->readFrom(Ljava/io/InputStream;JZ)V
...
.method public final readFrom(Ljava/io/InputStream;J)Lokio/Buffer;
    ...
    .line 2
    invoke-direct {p0, p1, p2, p3, v4}, Lokio/Buffer;->readFrom(Ljava/io/InputStream;JZ)V
...
.method public readHexadecimalUnsignedLong()J
    ...
    invoke-static/range {v15 .. v15}, Lokio/Buffer;->j(I)[C
    ...
    invoke-static/range {v15 .. v15}, Lokio/Buffer;->x(I)[C
...
.method public readString(JLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-direct {v7, v5, v4, v6, p3}, Ljava/lang/String;-><init>([BIILjava/nio/charset/Charset;)V
...
.method public readUtf8CodePoint()I
    ...
    .line 164
    invoke-direct {v4, v3}, Ljava/io/EOFException;-><init>(Ljava/lang/String;)V
...
.method public readUtf8LineStrict(J)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lokio/Buffer;->g(I)[C
    ...
    const p2, 0x3b6cb535    # 0.003611875f

    sub-int p0, p0, p2

    add-int/lit8 p0, p0, 0x73

    invoke-static/range {p0 .. p0}, Lokio/Buffer;->d(I)[C
    ...
    invoke-static/range {p0 .. p0}, Lokio/Buffer;->a(I)[C
...
.method public final snapshot(I)Lokio/ByteString;
    ...
    .line 17
    iput-boolean v9, v8, Lokio/Segment;->shared:Z
    ...
    invoke-direct {p1, v3, v5}, Lokio/SegmentedByteString;-><init>([[B[I)V
...
.method public final writableSegment$okio(I)Lokio/Segment;
    ...
    .line 39
    .line 40
    iget-boolean p1, v4, Lokio/Segment;->owner:Z
    ...
    .line 51
    invoke-virtual {v4, p1}, Lokio/Segment;->push(Lokio/Segment;)Lokio/Segment;
...
.method public write(Ljava/nio/ByteBuffer;)I
    ...
    invoke-virtual {p1, v7, v8, v6}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
...
.method public write(Lokio/ByteString;)Lokio/Buffer;
    ...
    .line 13
    invoke-virtual {p1, p0, v4, v3}, Lokio/ByteString;->write$okio(Lokio/Buffer;II)V
...
.method public writeDecimalLong(J)Lokio/Buffer;
    ...
    .line 3
    const p0, 0x249d1e67    # 6.81394E-17f
    ...
    invoke-static/range {p0 .. p0}, Lokio/Buffer;->w(I)[C
...
.method public writeString(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
    ...
    invoke-virtual {p0, p1, v4, p2}, Lokio/Buffer;->write([BII)Lokio/Buffer;
    ...
    .line 11
    invoke-static {p3, p2, p4}, La/b;->r(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 14
    invoke-static {p3, p1, p4, p2}, Ld1/f;->j(ILjava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
...
.method public writeString(Ljava/lang/String;Ljava/nio/charset/Charset;)Lokio/Buffer;
    ...
    .line 4
    invoke-virtual {p0, p1, v4, v3, p2}, Lokio/Buffer;->writeString(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
...
.method public writeUtf8(Ljava/lang/String;)Lokio/Buffer;
    ...
    invoke-virtual {p0, p1, v4, v3}, Lokio/Buffer;->writeUtf8(Ljava/lang/String;II)Lokio/Buffer;
...
.method public writeUtf8(Ljava/lang/String;II)Lokio/Buffer;
    ...
    invoke-static/range {p1 .. p1}, Lokio/Buffer;->t(I)[C
    ...
    invoke-static/range {p1 .. p1}, Lokio/Buffer;->o(I)[C
    ...
    invoke-static/range {p1 .. p1}, Lokio/Buffer;->n(I)[C
    ...
    .line 37
    invoke-static {p0, v13, v0}, La/b;->r(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const p3, 0x4dccb5f1    # 4.29309472E8f

    xor-int p1, p1, p3

    add-int/lit8 p1, p1, 0x70

    invoke-static/range {p1 .. p1}, Lokio/Buffer;->l(I)[C
    ...
    invoke-static/range {p1 .. p1}, Lokio/Buffer;->r(I)[C
    ...
    .line 40
    invoke-static {p0, v12, v0, v13}, Ld1/f;->j(ILjava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Lokio/Buffer;->f(I)[C
