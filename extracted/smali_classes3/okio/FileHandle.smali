...
.method private final readNoCloseCheck(JLokio/Buffer;J)J
    ...
    invoke-static/range {p3 .. p3}, Lokio/FileHandle;->a(I)[C
...
.method public final flush()V
    ...
    .line 1
    iget-boolean v3, p0, Lokio/FileHandle;->readWrite:Z
    ...
    .line 6
    :try_start_0
    iget-boolean v3, p0, Lokio/FileHandle;->closed:Z
...
.method public final position(Lokio/Sink;)J
    ...
    .line 11
    instance-of v3, p1, Lokio/RealBufferedSink;
    ...
    .line 13
    iget-object v3, p1, Lokio/RealBufferedSink;->bufferField:Lokio/Buffer;
    ...
    .line 16
    :goto_0
    instance-of v5, p1, Lokio/FileHandle$FileHandleSink;
...
.method public final position(Lokio/Source;)J
    ...
    .line 1
    instance-of v3, p1, Lokio/RealBufferedSource;
    ...
    .line 6
    :goto_0
    instance-of v5, p1, Lokio/FileHandle$FileHandleSource;
...
.method public final reposition(Lokio/Sink;J)V
    ...
    iget-object v3, p1, Lokio/RealBufferedSink;->sink:Lokio/Sink;

    .line 21
    instance-of v8, v3, Lokio/FileHandle$FileHandleSink;

    if-eqz v8, :cond_0

    move-object v8, v3

    check-cast v8, Lokio/FileHandle$FileHandleSink;

    invoke-virtual {v8}, Lokio/FileHandle$FileHandleSink;->getFileHandle()Lokio/FileHandle;
    ...
    .line 24
    invoke-virtual {v3, p2, p3}, Lokio/FileHandle$FileHandleSink;->setPosition(J)V
...
.method public final reposition(Lokio/Source;J)V
    ...
    iget-object v3, p1, Lokio/RealBufferedSource;->source:Lokio/Source;

    .line 3
    instance-of v8, v3, Lokio/FileHandle$FileHandleSource;

    if-eqz v8, :cond_0

    move-object v8, v3

    check-cast v8, Lokio/FileHandle$FileHandleSource;

    invoke-virtual {v8}, Lokio/FileHandle$FileHandleSource;->getFileHandle()Lokio/FileHandle;
    ...
    .line 5
    iget-object v4, p1, Lokio/RealBufferedSource;->bufferField:Lokio/Buffer;
...
.method public final sink(J)Lokio/Sink;
    ...
    .line 9
    .line 10
    iget v3, p0, Lokio/FileHandle;->openStreamCount:I
    ...
    .line 13
    .line 14
    iput v3, p0, Lokio/FileHandle;->openStreamCount:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 17
    new-instance v3, Lokio/FileHandle$FileHandleSink;

    .line 18
    .line 19
    invoke-direct {v3, p0, p1, p2}, Lokio/FileHandle$FileHandleSink;-><init>(Lokio/FileHandle;J)V
...
.method public final source(J)Lokio/Source;
    ...
    .line 13
    new-instance v3, Lokio/FileHandle$FileHandleSource;

    .line 14
    .line 15
    invoke-direct {v3, p0, p1, p2}, Lokio/FileHandle$FileHandleSource;-><init>(Lokio/FileHandle;J)V
