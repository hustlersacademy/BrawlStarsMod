...
.method public constructor <init>()V
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->dispatcher:Lokhttp3/Dispatcher;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->connectionPool:Lokhttp3/ConnectionPool;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->interceptors:Ljava/util/List;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->networkInterceptors:Ljava/util/List;

    .line 6
    sget-object v3, Lokhttp3/EventListener;->NONE:Lokhttp3/EventListener;

    invoke-static {v3}, Lokhttp3/internal/Util;->asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;

    move-result-object v3

    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->eventListenerFactory:Lokhttp3/EventListener$Factory;

    const/4 v3, 0x1

    .line 7
    iput-boolean v3, p0, Lokhttp3/OkHttpClient$Builder;->retryOnConnectionFailure:Z

    .line 8
    sget-object v4, Lokhttp3/Authenticator;->NONE:Lokhttp3/Authenticator;

    iput-object v4, p0, Lokhttp3/OkHttpClient$Builder;->authenticator:Lokhttp3/Authenticator;

    .line 9
    iput-boolean v3, p0, Lokhttp3/OkHttpClient$Builder;->followRedirects:Z

    .line 10
    iput-boolean v3, p0, Lokhttp3/OkHttpClient$Builder;->followSslRedirects:Z

    .line 11
    sget-object v3, Lokhttp3/CookieJar;->NO_COOKIES:Lokhttp3/CookieJar;

    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->cookieJar:Lokhttp3/CookieJar;

    .line 12
    sget-object v3, Lokhttp3/Dns;->SYSTEM:Lokhttp3/Dns;

    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->dns:Lokhttp3/Dns;

    .line 13
    iput-object v4, p0, Lokhttp3/OkHttpClient$Builder;->proxyAuthenticator:Lokhttp3/Authenticator;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->socketFactory:Ljavax/net/SocketFactory;

    .line 15
    sget-object v3, Lokhttp3/OkHttpClient;->Companion:Lokhttp3/OkHttpClient$Companion;

    invoke-virtual {v3}, Lokhttp3/OkHttpClient$Companion;->getDEFAULT_CONNECTION_SPECS$okhttp()Ljava/util/List;

    move-result-object v4

    iput-object v4, p0, Lokhttp3/OkHttpClient$Builder;->connectionSpecs:Ljava/util/List;

    .line 16
    invoke-virtual {v3}, Lokhttp3/OkHttpClient$Companion;->getDEFAULT_PROTOCOLS$okhttp()Ljava/util/List;

    move-result-object v3

    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->protocols:Ljava/util/List;

    .line 17
    sget-object v3, Lokhttp3/internal/tls/OkHostnameVerifier;->INSTANCE:Lokhttp3/internal/tls/OkHostnameVerifier;

    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;

    .line 18
    sget-object v3, Lokhttp3/CertificatePinner;->DEFAULT:Lokhttp3/CertificatePinner;

    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->certificatePinner:Lokhttp3/CertificatePinner;

    const/16 v3, 0x2710

    .line 19
    iput v3, p0, Lokhttp3/OkHttpClient$Builder;->connectTimeout:I

    .line 20
    iput v3, p0, Lokhttp3/OkHttpClient$Builder;->readTimeout:I

    .line 21
    iput v3, p0, Lokhttp3/OkHttpClient$Builder;->writeTimeout:I

    const-wide/16 v3, 0x400

    .line 22
    iput-wide v3, p0, Lokhttp3/OkHttpClient$Builder;->minWebSocketMessageToCompress:J
...
.method public constructor <init>(Lokhttp3/OkHttpClient;)V
    ...
    .line 26
    iget-object v3, p0, Lokhttp3/OkHttpClient$Builder;->interceptors:Ljava/util/List;
    ...
    .line 27
    iget-object v3, p0, Lokhttp3/OkHttpClient$Builder;->networkInterceptors:Ljava/util/List;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->authenticator:Lokhttp3/Authenticator;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->cache:Lokhttp3/Cache;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->proxy:Ljava/net/Proxy;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->proxySelector:Ljava/net/ProxySelector;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->proxyAuthenticator:Lokhttp3/Authenticator;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->sslSocketFactoryOrNull:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->x509TrustManagerOrNull:Ljavax/net/ssl/X509TrustManager;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->connectionSpecs:Ljava/util/List;
    ...
    iput-object v3, p0, Lokhttp3/OkHttpClient$Builder;->certificateChainCleaner:Lokhttp3/internal/tls/CertificateChainCleaner;
...
.method public final -addInterceptor(Lkotlin/jvm/functions/Function1;)Lokhttp3/OkHttpClient$Builder;
    ...
    .line 5
    .line 6
    new-instance v3, Lokhttp3/OkHttpClient$Builder$addInterceptor$2;

    .line 7
    .line 8
    invoke-direct {v3, p1}, Lokhttp3/OkHttpClient$Builder$addInterceptor$2;-><init>(Lkotlin/jvm/functions/Function1;)V

    .line 9
    .line 10
    .line 11
    invoke-virtual {p0, v3}, Lokhttp3/OkHttpClient$Builder;->addInterceptor(Lokhttp3/Interceptor;)Lokhttp3/OkHttpClient$Builder;
...
.method public final -addNetworkInterceptor(Lkotlin/jvm/functions/Function1;)Lokhttp3/OkHttpClient$Builder;
    ...
    .line 5
    .line 6
    new-instance v3, Lokhttp3/OkHttpClient$Builder$addNetworkInterceptor$2;

    .line 7
    .line 8
    invoke-direct {v3, p1}, Lokhttp3/OkHttpClient$Builder$addNetworkInterceptor$2;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public final callTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-static {v3, p1, p2, p3}, Lokhttp3/internal/Util;->checkDuration(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I
...
.method public final callTimeout(Ljava/time/Duration;)Lokhttp3/OkHttpClient$Builder;
    ...
    .line 2
    invoke-static {p1}, Lio/sentry/x3;->e(Ljava/time/Duration;)J

    move-result-wide v3

    sget-object p1, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {p0, v3, v4, p1}, Lokhttp3/OkHttpClient$Builder;->callTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
...
.method public final certificatePinner(Lokhttp3/CertificatePinner;)Lokhttp3/OkHttpClient$Builder;
    ...
    .line 17
    invoke-virtual {p0, v3}, Lokhttp3/OkHttpClient$Builder;->setRouteDatabase$okhttp(Lokhttp3/internal/connection/RouteDatabase;)V
...
.method public final connectTimeout(Ljava/time/Duration;)Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-virtual {p0, v3, v4, p1}, Lokhttp3/OkHttpClient$Builder;->connectTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
...
.method public final pingInterval(Ljava/time/Duration;)Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-virtual {p0, v3, v4, p1}, Lokhttp3/OkHttpClient$Builder;->pingInterval(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
...
.method public final readTimeout(Ljava/time/Duration;)Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-virtual {p0, v3, v4, p1}, Lokhttp3/OkHttpClient$Builder;->readTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
...
.method public final sslSocketFactory(Ljavax/net/ssl/SSLSocketFactory;)Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-virtual {v4, p1}, Lokhttp3/internal/platform/Platform;->trustManager(Ljavax/net/ssl/SSLSocketFactory;)Ljavax/net/ssl/X509TrustManager;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {p0, v4}, Lokhttp3/OkHttpClient$Builder;->setX509TrustManagerOrNull$okhttp(Ljavax/net/ssl/X509TrustManager;)V
    ...
    invoke-virtual {p1, v3}, Lokhttp3/internal/platform/Platform;->buildCertificateChainCleaner(Ljavax/net/ssl/X509TrustManager;)Lokhttp3/internal/tls/CertificateChainCleaner;
...
.method public final writeTimeout(Ljava/time/Duration;)Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-virtual {p0, v3, v4, p1}, Lokhttp3/OkHttpClient$Builder;->writeTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;
