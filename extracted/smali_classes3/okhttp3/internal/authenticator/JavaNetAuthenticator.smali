...
.method private final connectToInetAddress(Ljava/net/Proxy;Lokhttp3/HttpUrl;Lokhttp3/Dns;)Ljava/net/InetAddress;
    ...
    .line 9
    :cond_0
    sget-object v4, Lokhttp3/internal/authenticator/JavaNetAuthenticator$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .line 28
    invoke-static {p1}, Ldj/i0;->first(Ljava/util/List;)Ljava/lang/Object;
...
.method public authenticate(Lokhttp3/Route;Lokhttp3/Response;)Lokhttp3/Request;
    ...
    .line 2
    .line 3
    const v21, 0x1f56563c

    const v20, 0x110cc1dd
    ...
    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->a(I)[C
    ...
    .line 67
    const v21, 0x6769733f

    const v20, 0x190aac15
    ...
    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->e(I)[C
    ...
    .line 68
    .line 69
    invoke-static {v10, v9, v6}, Lkotlin/text/a0;->equals(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 95
    :cond_7
    const v21, 0x6be8d20b

    const v20, -0x7125d5ed
    ...
    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->f(I)[C
    ...
    .line 146
    .line 147
    const v21, 0x448aa653

    const v20, -0xf5abb3a

    rsub-int/lit8 v21, v21, 0x6c

    xor-int v21, v21, v20

    move-object/16 v20, p0

    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->g(I)[C
    ...
    .line 202
    .line 203
    const v21, 0x590426dd

    const v20, 0x4a05c5b1    # 2191724.2f
    ...
    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->d(I)[C
    ...
    .line 206
    :cond_a
    const v21, 0x1ebd99db

    const v20, -0x52830d0a
    ...
    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->b(I)[C
    ...
    .line 212
    const v21, 0x686ebbe0

    const v20, -0x1fe8063e
    ...
    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->c(I)[C
    ...
    .line 223
    const v21, 0x2394bd4a

    const v20, -0xce9426a

    add-int v21, v21, v20

    add-int/lit8 v21, v21, 0x74

    move-object/16 v20, p0

    invoke-direct/range {v20 .. v21}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->h(I)[C
