...
.method private final promoteAndExecute()Z
    ...
    .line 77
    .line 78
    iget-object v7, p0, Lokhttp3/Dispatcher;->runningAsyncCalls:Ljava/util/ArrayDeque;
    ...
    .line 91
    :cond_2
    invoke-virtual {v6}, Lokhttp3/internal/connection/RealCall$AsyncCall;->getCallsPerHost()Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 163
    invoke-virtual {v6, v9}, Lokhttp3/internal/connection/RealCall$AsyncCall;->executeOn(Ljava/util/concurrent/ExecutorService;)V
...
.method public final enqueue$okhttp(Lokhttp3/internal/connection/RealCall$AsyncCall;)V
    ...
    .line 16
    invoke-virtual {v3}, Lokhttp3/internal/connection/RealCall;->getForWebSocket()Z
    ...
    .line 26
    invoke-direct {p0, v3}, Lokhttp3/Dispatcher;->findExistingCallWithHost(Ljava/lang/String;)Lokhttp3/internal/connection/RealCall$AsyncCall;
    ...
    .line 31
    .line 32
    invoke-virtual {p1, v3}, Lokhttp3/internal/connection/RealCall$AsyncCall;->reuseCallsPerHostFrom(Lokhttp3/internal/connection/RealCall$AsyncCall;)V
...
.method public final finished$okhttp(Lokhttp3/internal/connection/RealCall$AsyncCall;)V
    ...
    invoke-direct {p0, v3, p1}, Lokhttp3/Dispatcher;->finished(Ljava/util/Deque;Ljava/lang/Object;)V
...
.method public final declared-synchronized queuedCalls()Ljava/util/List;
    ...
    .line 30
    .line 31
    invoke-virtual {v5}, Lokhttp3/internal/connection/RealCall$AsyncCall;->getCall()Lokhttp3/internal/connection/RealCall;
