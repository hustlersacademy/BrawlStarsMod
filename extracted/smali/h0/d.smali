...
.method public static computeCropRectFromAspectRatio(Landroid/util/Size;Landroid/util/Rational;)Landroid/graphics/Rect;
    ...
    .line 1
    invoke-static {p1}, Lh0/d;->isAspectRatioValid(Landroid/util/Rational;)Z
    ...
    .line 10
    .line 11
    invoke-static {p0, p1}, Lx/p2;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 79
    invoke-direct {v4, v6, p1, v3, p0}, Landroid/graphics/Rect;-><init>(IIII)V
...
.method public static computeCropRectFromDispatchInfo(Landroid/graphics/Rect;ILandroid/util/Size;I)Landroid/graphics/Rect;
    ...
    .line 10
    .line 11
    invoke-static {p2}, Lh0/d;->sizeToVertexes(Landroid/util/Size;)[F
    ...
    .line 29
    .line 30
    invoke-static {p2, p3, v1, v2}, Lh0/d;->min(FFFF)F
    ...
    .line 45
    .line 46
    invoke-static {p3, v1, v2, p1}, Lh0/d;->min(FFFF)F
...
.method public static createBitmapFromPlane([Lx/g2;II)Landroid/graphics/Bitmap;
    .locals 7
    .param p0    # [Lx/g2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 10
    .line 11
    invoke-static {v3, v6}, Lk1/i;->checkArgument(ZLjava/lang/Object;)V
    ...
    .line 17
    .line 18
    invoke-virtual {v3}, Lx/a;->getPixelStride()I
    ...
    .line 36
    .line 37
    invoke-virtual {v3}, Lx/a;->getRowStride()I
    ...
    .line 48
    .line 49
    invoke-static {v5, v3}, Lk1/i;->checkArgument(ZLjava/lang/Object;)V
...
.method public static jpegImageToJpegByteArray(Lx/h2;)[B
    .locals 6
    .param p0    # Lx/h2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static jpegImageToJpegByteArray(Lx/h2;Landroid/graphics/Rect;I)[B
    .locals 6
    .param p0    # Lx/h2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 10
    invoke-static {p0}, Lh0/d;->jpegImageToJpegByteArray(Lx/h2;)[B
    ...
    invoke-static {p0, v5, v4, v5}, Landroid/graphics/BitmapRegionDecoder;->newInstance([BIIZ)Landroid/graphics/BitmapRegionDecoder;
    ...
    invoke-virtual {p0, p1, v4}, Landroid/graphics/BitmapRegionDecoder;->decodeRegion(Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p1, v3, p2, p0}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    ...
    sget-object p2, Lh0/b;->ENCODE_FAILED:Lh0/b;

    invoke-direct {p0, p1, p2}, Lh0/c;-><init>(Ljava/lang/String;Lh0/b;)V
    ...
    sget-object p1, Lh0/b;->DECODE_FAILED:Lh0/b;

    invoke-direct {p0, v3, p1}, Lh0/c;-><init>(Ljava/lang/String;Lh0/b;)V
    ...
    sget-object p2, Lh0/b;->DECODE_FAILED:Lh0/b;

    invoke-direct {p1, p0, p2}, Lh0/c;-><init>(Ljava/lang/String;Lh0/b;)V
...
.method public static shouldCropImage(Lx/h2;)Z
    .locals 3
    .param p0    # Lx/h2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-interface {p0}, Lx/h2;->getCropRect()Landroid/graphics/Rect;
    ...
    .line 3
    invoke-static {v0, v1, v2, p0}, Lh0/d;->shouldCropImage(IIII)Z
...
.method public static yuvImageToJpegByteArray(Lx/h2;Landroid/graphics/Rect;I)[B
    .locals 12
    .param p0    # Lx/h2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 8
    .line 9
    invoke-static {p0}, Lh0/d;->yuv_420_888toNv21(Lx/h2;)[B
    ...
    .line 42
    invoke-direct {p1, v5, v5, v3, p0}, Landroid/graphics/Rect;-><init>(IIII)V

    .line 43
    .line 44
    .line 45
    :cond_0
    invoke-virtual {v11, p1, p2, v4}, Landroid/graphics/YuvImage;->compressToJpeg(Landroid/graphics/Rect;ILjava/io/OutputStream;)Z
...
.method public static yuv_420_888toNv21(Lx/h2;)[B
    .locals 19
    .param p0    # Lx/h2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 124
    invoke-virtual {v2}, Lx/a;->getRowStride()I
    ...
    .line 132
    invoke-virtual {v2}, Lx/a;->getPixelStride()I
