...
# static fields
.field public static final IMAGE_INFO_PROCESSOR:Lz/d1;
...
.field public static final OPTION_PREVIEW_CAPTURE_PROCESSOR:Lz/d1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lz/d1;"
        }
...
.field public static final OPTION_RGBA8888_SURFACE_REQUIRED:Lz/d1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lz/d1;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-static/range {v0 .. v0}, Lz/k2;->b(I)[C
    ...
    .line 2
    .line 3
    const-class v4, Lz/r1;

    .line 4
    .line 5
    invoke-static {v3, v4}, Lz/d1;->create(Ljava/lang/String;Ljava/lang/Class;)Lz/d1;
    ...
    .line 9
    sput-object v3, Lz/k2;->IMAGE_INFO_PROCESSOR:Lz/d1;

    .line 10
    .line 11
    const v0, 0x4c1d298b    # 4.1199148E7f
    ...
    invoke-static/range {v0 .. v0}, Lz/k2;->c(I)[C
    ...
    .line 19
    sput-object v3, Lz/k2;->OPTION_PREVIEW_CAPTURE_PROCESSOR:Lz/d1;
    ...
    invoke-static/range {v0 .. v0}, Lz/k2;->a(I)[C
    ...
    .line 29
    sput-object v3, Lz/k2;->OPTION_RGBA8888_SURFACE_REQUIRED:Lz/d1;
...
.method public constructor <init>(Lz/j2;)V
    .locals 0
    .param p1    # Lz/j2;
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lz/k2;->a:Lz/j2;
...
.method public bridge synthetic getAppTargetRotation(I)I
    .locals 0

    .line 1
    invoke-super {p0, p1}, Lz/u1;->getAppTargetRotation(I)I
...
.method public bridge synthetic getBackgroundExecutor()Ljava/util/concurrent/Executor;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 1
    invoke-super {p0}, Ld0/n;->getBackgroundExecutor()Ljava/util/concurrent/Executor;
...
.method public bridge synthetic getBackgroundExecutor(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    .locals 0
    ...
    .line 2
    invoke-super {p0, p1}, Ld0/n;->getBackgroundExecutor(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
...
.method public getCaptureProcessor()Lz/a1;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-virtual {p0, v0}, Lz/k2;->retrieveOption(Lz/d1;)Ljava/lang/Object;
...
.method public getCaptureProcessor(Lz/a1;)Lz/a1;
    .locals 1
    .param p1    # Lz/a1;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, v0, p1}, Lz/k2;->retrieveOption(Lz/d1;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getConfig()Lz/g1;
    ...
    .line 1
    iget-object v0, p0, Lz/k2;->a:Lz/j2;
...
.method public bridge synthetic getDefaultResolution()Landroid/util/Size;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 1
    invoke-super {p0}, Lz/u1;->getDefaultResolution()Landroid/util/Size;
...
.method public bridge synthetic getDefaultResolution(Landroid/util/Size;)Landroid/util/Size;
    .locals 0
    ...
    .line 2
    invoke-super {p0, p1}, Lz/u1;->getDefaultResolution(Landroid/util/Size;)Landroid/util/Size;
...
.method public getImageInfoProcessor(Lz/r1;)Lz/r1;
    .locals 1
    .param p1    # Lz/r1;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 1
    sget-object v0, Lz/k2;->IMAGE_INFO_PROCESSOR:Lz/d1;
...
.method public bridge synthetic getMaxResolution()Landroid/util/Size;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 1
    invoke-super {p0}, Lz/u1;->getMaxResolution()Landroid/util/Size;
...
.method public bridge synthetic getMaxResolution(Landroid/util/Size;)Landroid/util/Size;
    .locals 0
    .param p1    # Landroid/util/Size;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 2
    invoke-super {p0, p1}, Lz/u1;->getMaxResolution(Landroid/util/Size;)Landroid/util/Size;
...
.method public bridge synthetic getSupportedResolutions()Ljava/util/List;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 1
    invoke-super {p0}, Lz/u1;->getSupportedResolutions()Ljava/util/List;
...
.method public bridge synthetic getSupportedResolutions(Ljava/util/List;)Ljava/util/List;
    .locals 0
    ...
    .line 2
    invoke-super {p0, p1}, Lz/u1;->getSupportedResolutions(Ljava/util/List;)Ljava/util/List;
...
.method public bridge synthetic getTargetAspectRatio()I
    .locals 1

    .line 1
    invoke-super {p0}, Lz/u1;->getTargetAspectRatio()I
...
.method public bridge synthetic getTargetResolution()Landroid/util/Size;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 1
    invoke-super {p0}, Lz/u1;->getTargetResolution()Landroid/util/Size;
...
.method public bridge synthetic getTargetResolution(Landroid/util/Size;)Landroid/util/Size;
    .locals 0
    .param p1    # Landroid/util/Size;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 2
    invoke-super {p0, p1}, Lz/u1;->getTargetResolution(Landroid/util/Size;)Landroid/util/Size;
...
.method public bridge synthetic getTargetRotation()I
    .locals 1

    .line 1
    invoke-super {p0}, Lz/u1;->getTargetRotation()I
...
.method public bridge synthetic getTargetRotation(I)I
    .locals 0

    .line 2
    invoke-super {p0, p1}, Lz/u1;->getTargetRotation(I)I
...
.method public bridge synthetic hasTargetAspectRatio()Z
    .locals 1

    .line 1
    invoke-super {p0}, Lz/u1;->hasTargetAspectRatio()Z
...
.method public isRgba8888SurfaceRequired(Z)Z
    ...
    .line 1
    sget-object v0, Lz/k2;->OPTION_RGBA8888_SURFACE_REQUIRED:Lz/d1;
